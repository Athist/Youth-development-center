...
namespace LPX2YCDProject2020.Migrations
{
    ...
    [Migration("20210622200133_ProfileModelsUpdate")]
    partial class ProfileModelsUpdate
    {
            ...
            modelBuilder.Entity("LPX2YCDProject2020.Models.Account.StudentSubjects", b =>
                {
                    ...
                    b.Property<int?>("StudentProfileModelId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("StudentProfileModelId");
            ...
            modelBuilder.Entity("LPX2YCDProject2020.Models.Account.StudentSubjects", b =>
                {
                    b.HasOne("LPX2YCDProject2020.Models.Account.StudentProfileModel", null)
                        .WithMany("Enrolments")
                        .HasForeignKey("StudentProfileModelId");
